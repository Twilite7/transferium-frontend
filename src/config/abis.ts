...
export const PLAYER_REGISTRY_ABI = [
  ...
  "function setClubName(address club, string name) external",
  "function getClubName(address club) external view returns (string)",
...
export const SWAP_ESCROW_ABI = [
  "function proposeSwap(uint256 playerA, uint256 playerB, address paymentToken, uint256 topUpAmount, uint256 clubAAgentBps, address clubAAgent, uint256 clubBAgentBps, address clubBAgent) external returns (uint256)",
  "function acceptSwap(uint256 swapId) external",
  "function rejectSwap(uint256 swapId) external",
  "function consentToSwap(uint256 swapId) external",
  "function fundSwap(uint256 swapId) external",
  "function submitMedicalAonB(uint256 swapId, uint8 outcome, bytes32 hash) external",
  "function submitMedicalBonA(uint256 swapId, uint8 outcome, bytes32 hash) external",
  "function processExpiry(uint256 swapId) external",
  "function raiseDispute(uint256 swapId) external",
  "function resolveDispute(uint256 swapId) external",
  "function proposeMutualCancel(uint256 swapId) external",
  "function confirmMutualCancel(uint256 swapId) external",
  "function withdrawProposal(uint256 swapId) external",
  "function forceCancel(uint256 swapId) external",
  "function getSwap(uint256 swapId) external view returns (tuple(uint256 playerA, uint256 playerB, address clubA, address clubB, address paymentToken, uint256 topUpAmount, uint256 clubAAgentBps, address clubAAgent, uint256 clubBAgentBps, address clubBAgent, uint8 state, uint256 stateDeadline, uint256 proposedAt, uint256 fundedAt, bool frozen))",
...
export const FREE_TRANSFER_ESCROW_ABI = [
  "function proposePreContract(uint256 playerId, address paymentToken, uint256 signingBonus, uint256 buyerAgentBps, address buyerAgent, uint256 sellerAgentBps, address sellerAgent) external returns (uint256)",
  "function withdrawPreContract(uint256 ftId) external",
  "function signPreContract(uint256 ftId) external",
  "function lockDeposit(uint256 ftId) external",
  "function submitMedical(uint256 ftId, uint8 outcome, bytes32 medicalHash) external",
  "function getFreeTransfer(uint256 ftId) external view returns (tuple(uint256 playerId, address buyingClub, address paymentToken, uint256 signingBonus, uint256 deposit, uint256 buyerAgentBps, address buyerAgent, uint256 sellerAgentBps, address sellerAgent, uint8 state, uint256 stateDeadline, uint256 createdAt))",
  ...
  "function proposeMutualTermination(uint256 playerId, address paymentToken, uint256 settlementAmount) external",
  "function confirmMutualTermination(uint256 playerId) external",
  "function withdrawMutualTermination(uint256 playerId) external",
  "function releaseExpiredContract(uint256 playerId) external",
  "function getClaimable(address account, address token) external view returns (uint256)",
  "function withdrawClaimable(address token) external",
  "function getTermination(uint256 playerId) external view returns (tuple(uint256 playerId, address club, address paymentToken, uint256 settlementAmount, uint256 proposedAt, bool exists))",
  "function getProposal(uint256 playerId, address club) external view returns (uint256)",
  "function depositBps() external view returns (uint256)",
] as const

export const INSTALLMENT_ESCROW_ABI = [{"inputs":[{"internalType":"address","name":"_dealEscrow","type":"address"},{"internalType":"address","name":"_treasury","type":"address"},{"internalType":"uint256","name":"_protocolFeeBps","type":"uint256"}],"stateMutability":"nonpayable","type":"constructor"},{"inputs":[],"name":"AccessControlBadConfirmation","type":"error"},{"inputs":[{"internalType":"address","name":"account","type":"address"},{"internalType":"bytes32","name":"neededRole","type":"bytes32"}],"name":"AccessControlUnauthorizedAccount","type":"error"},{"inputs":[],"name":"EnforcedPause","type":"error"},{"inputs":[],"name":"ExpectedPause","type":"error"},{"inputs":[],"name":"InstallmentAlreadyPaid","type":"error"},{"inputs":[],"name":"InstallmentNotDue","type":"error"},{"inputs":[],"name":"InstallmentNotOverdue","type":"error"},{"inputs":[],"name":"InvalidIndex","type":"error"},{"inputs":[],"name":"NotBuyingClub","type":"error"},{"inputs":[],"name":"NothingToClaim","type":"error"},{"inputs":[],"name":"ReentrancyGuardReentrantCall","type":"error"},{"inputs":[{"internalType":"address","name":"token","type":"address"}],"name":"SafeERC20FailedOperation","type":"error"},{"inputs":[],"name":"WrongDealState","type":"error"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"recipient","type":"address"},{"indexed":true,"internalType":"address","name":"token","type":"address"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"Claimed","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"uint256","name":"dealId","type":"uint256"},{"indexed":true,"internalType":"uint8","name":"index","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"dueDate","type":"uint256"}],"name":"InstallmentOverdue","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"uint256","name":"dealId","type":"uint256"},{"indexed":true,"internalType":"uint8","name":"index","type":"uint8"},{"indexed":false,"internalType":"uint256","name":"amount","type":"uint256"}],"name":"InstallmentPaid","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"account","type":"address"}],"name":"Paused","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"bytes32","name":"role","type":"bytes32"},{"indexed":true,"internalType":"bytes32","name":"previousAdminRole","type":"bytes32"},{"indexed":true,"internalType":"bytes32","name":"newAdminRole","type":"bytes32"}],"name":"RoleAdminChanged","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"bytes32","name":"role","type":"bytes32"},{"indexed":true,"internalType":"address","name":"account","type":"address"},{"indexed":true,"internalType":"address","name":"sender","type":"address"}],"name":"RoleGranted","type":"event"},{"anonymous":false,"inputs":[{"indexed":true,"internalType":"bytes32","name":"role","type":"bytes32"},{"indexed":true,"internalType":"address","name":"account","type":"address"},{"indexed":true,"internalType":"address","name":"sender","type":"address"}],"name":"RoleRevoked","type":"event"},{"anonymous":false,"inputs":[{"indexed":false,"internalType":"address","name":"account","type":"address"}],"name":"Unpaused","type":"event"},{"inputs":[],"name":"DEFAULT_ADMIN_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"LEAGUE_ROLE","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"address","name":"token","type":"address"}],"name":"claim","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"account","type":"address"},{"internalType":"address","name":"token","type":"address"}],"name":"claimable","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"dealEscrow","outputs":[{"internalType":"contract IDealEscrow","name":"","type":"address"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"dealId","type":"uint256"},{"internalType":"uint8","name":"index","type":"uint8"}],"name":"flagOverdue","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"bytes32","name":"role","type":"bytes32"}],"name":"getRoleAdmin","outputs":[{"internalType":"bytes32","name":"","type":"bytes32"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"bytes32","name":"role","type":"bytes32"},{"internalType":"address","name":"account","type":"address"}],"name":"grantRole","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"bytes32","name":"role","type":"bytes32"},{"internalType":"address","name":"account","type":"address"}],"name":"hasRole","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"paused","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"uint256","name":"dealId","type":"uint256"},{"internalType":"uint8","name":"index","type":"uint8"}],"name":"payInstallment","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[],"name":"protocolFeeBps","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"inputs":[{"internalType":"bytes32","name":"role","type":"bytes32"},{"internalType":"address","name":"callerConfirmation","type":"address"}],"name":"renounceRole","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"bytes32","name":"role","type":"bytes32"},{"internalType":"address","name":"account","type":"address"}],"name":"revokeRole","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"bytes4","name":"interfaceId","type":"bytes4"}],"name":"supportsInterface","outputs":[{"internalType":"bool","name":"","type":"bool"}],"stateMutability":"view","type":"function"},{"inputs":[],"name":"treasury","outputs":[{"internalType":"address","name":"","type":"address"}],"stateMutability":"view","type":"function"}] as const;
